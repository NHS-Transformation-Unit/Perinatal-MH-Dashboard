...
DBI::dbExecute(con, statement = read_file(paste0(here(),"/src/extract_queries/sql_scripts/udal_sql_scripts/MHSDS_Q2_Caseload_Main.sql")), immediate=TRUE)
q2_main_raw_df <- DBI::dbGetQuery(con, statement = read_file(paste0(here(),"/src/extract_queries/sql_scripts/udal_sql_scripts/read_Q2_Caseload_Main.sql")))

DBI::dbExecute(con, statement = read_file(paste0(here(),"/src/extract_queries/sql_scripts/udal_sql_scripts/MHSDS_Q2_Caseload_Snap.sql")), immediate=TRUE)
q2_snap_raw_df <- DBI::dbGetQuery(con, statement = read_file(paste0(here(),"/src/extract_queries/sql_scripts/udal_sql_scripts/read_Q2_Caseload_Snap.sql")))
